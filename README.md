...
### Руководство по использованию файла App_parser.exe
В папке _App_parser_ содержится файл _App_parser.exe_, который осуществляет выполнение программы без необходимости вхождения в _IDE_. После двойного нажатия на данный файл открывается консольное приложение, в котором для доступа к базе данных нужно будет ввести имя пользователя и пароль к базе данных. После данных действий начнётся обновление информации, хранящейся в таблице _news_.
